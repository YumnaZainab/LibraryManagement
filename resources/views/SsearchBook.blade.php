        ...
        <div class="row justify-content-md-center">
            ...
            <div class="box">
                ...
                <div class="inside-header">
                    <h3 style="font-family: Serif;">SEARCH BOOKS</h3>
                </div>
                <div style="font-family: Serif;" class="content">
                <form action="">
                    <label for="username">Enter Title of the book</label> <br>
                    <input type="text" name="username" id="username"> <br><br>
                    <div class="center">
                        <input onclick="location.href='/searchedBook'" class="btn"  type="submit"  value="Search">
                    </div>
                </form>
