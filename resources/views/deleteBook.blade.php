        ...
        <div class="aside">
            ...
            <div class="container">
                ...
                <div class="inside-header">
                    <h3 style="font-family: Serif;">DELETE BOOK</h3>
                </div>
                <div style="font-family: Serif;" class="contentt">
                <form action="delBook" method="post" onsubmit="return validate()">
                    @csrf
                    <label for="title">Enter book title that is to be deleted</label> 
...
<div class="footer">
    ...
    <script>
        ...
        function validate(){
            titlee = document.getElementById('title').value;
