        ...
        <div class="aside">
            ...
            <div class="container">
                ...
                <div class="inside-header">
                    <h3 style="font-family: Serif;">UPDATE BOOK</h3>
                </div>
                <div style="font-family: Serif;" class="contentt">
                <?php 
                foreach ($B_id as $Data) {
                    
                    $book_title = $Data->title;
                }
                    ?>
                <form action="/upBook/{{$book_title}}" method="post"  onsubmit="return validate()">

                    @csrf
                    
                    <label for="num">Enter Updated Number of Issues</label>
